...
class Perfil: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        var myUser = Singleton.shared.myUser
    ...
    @IBAction func editaPerfil(_ sender: Any) {
        let alert = UIAlertController(title: "Perfil", message: "Estaries editant el perfil", preferredStyle: UIAlertController.Style.alert)
        alert.addAction(UIAlertAction(title: "OK", style: UIAlertAction.Style.default, handler: nil))
        self.present(alert, animated: true, completion: nil)
    }
    
    @IBAction func discover(_ sender: Any) {
        let alert = UIAlertController(title: "Options", message: "Coming soon", preferredStyle: UIAlertController.Style.alert)
        alert.addAction(UIAlertAction(title: "OK", style: UIAlertAction.Style.default, handler: nil))
        self.present(alert, animated: true, completion: nil)
    }
    ...
    @IBAction func options(_ sender: Any) {
        let alert = UIAlertController(title: "Alerta", message: "Options disabled", preferredStyle: UIAlertController.Style.alert)
